...
//	@Mapping(target = "id", ignore = true)
//    @Mapping(target = "endereco.id", ignore = true) 
//	@Mapping(target = "ocorrenciaEntity.endereco", source =  "endereco")
//	void atualizarOcorrencia(@MappingTarget OcorrenciaEntity ocorrenciaEntity, OcorrenciaVO ocorrencia);
